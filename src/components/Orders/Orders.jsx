              ...
              <div>
                <div>
                  ...
                  <div className="p-2 w-full">
                    <button
                      onClick={display}
                      className="flex mx-auto text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pnk-600 rounded text-lg"
                    >
                      CHECK INVOICES
                    </button>
                  </div>
                  ...
                  <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                        <h1 className="text-pink-600 text-3xl title-font font-medium mb-4">
                          Track your product{" "}
                        </h1>
