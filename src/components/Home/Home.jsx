        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-pink-100 p-8 rounded">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="block w-5 h-5 text-pink-400 mb-4"
                ...
                <a className="inline-flex items-center">
                  ...
                  <span className="flex-grow flex flex-col pl-4">
                    <span className="title-font font-medium text-pink-900">
                      Holden Caulfield
                    </span>
                    <span className="text-pink-500 text-sm">UI DEVELOPER</span>
                  </span>
                </a>
              </div>
            </div>
              ...
              <div className="h-full bg-pink-100 p-8 rounded">
                ...
                <a className="inline-flex items-center">
                  ...
                  <span className="flex-grow flex flex-col pl-4">
                    ...
                    <span className="text-pink-500 text-sm">DESIGNER</span>
                  </span>
                </a>
              </div>
            </div>
